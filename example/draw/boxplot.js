...
function drawaBox(i, g, d, globalMin, globalMax, ymin, yQ1, yMV, yQ3, ymax){
  ...
  // g.append('rect')
  //  .attr('class', 'boxrect-bottom')
  //  .attr('width', boxWidth - 4)
  //  .attr('height', function(){
  //   return yScale(yQ1) - yScale(yMV);
  //  })
  //  .attr('x', function(){
  //   return 2
  //  })
  ...
  //   // return 'red'
  //   return 'none'
  //   // return colorFunc_bottom(yScale(yQ1) - yScale(yMV))
  //   // return 'none';
  // })
  //  .style('stroke', 'black')
  //  .style('stroke-width', function(){
  //   console.log(' stroke-width ', ((yScale(yQ1) - yScale(yMV))/step))
  //   return 10 - ((yScale(yQ1) - yScale(yMV))/step) + 'px';
  //  });
    

  // g.append('rect')
  //  .attr('class', 'boxrect-up')
  //  .attr('width', boxWidth - (10 - ((yScale(yMV) - yScale(yQ3))/step)) * shinkRatio)
  //  .attr('height', function(){
  //   return yScale(yMV) - yScale(yQ3);
  //  })
  //  .attr('x', function(){
  //   return (10 - ((yScale(yMV) - yScale(yQ3))/step))*shinkRatio
  //  })
  //  .attr('y', function(){
  //   return yScale(yQ3);
  //  })
  ...
  //   // return 'red'
  //   return 'none'
  //   // return colorFunc_up(yScale(yMV) - yScale(yQ3))
  //   // return 'none';
  // })
  //  .style('stroke', 'black')
  //  .style('stroke-width', function(){
  //     console.log(' stroke-width ', ((yScale(yMV) - yScale(yQ3))/step))
  //     return 10 - ((yScale(yMV) - yScale(yQ3))/step) + 'px';
  //  })
