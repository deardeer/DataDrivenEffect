...
function AnimateEnhancer(){
	...
	this.marchingAnt = function(maGeoInfo, aeInfo){
		...
		if(antType == 'self-defined'){
			...
			console.log("antDom", defineAntDom, antDom)

			// liGeometryDot: Array(n)
			...
			console.log("firstSegLength",firstSegLength)
			console.log("cenPosLength",cenPosLength)
			console.log("b1",b1)
			console.log("antDomInfo", antDomInfo)
...
// export default animateenhancer;
module.exports = AnimateEnhancer